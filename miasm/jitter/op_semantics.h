...
_MIASM_EXPORT uint64_t fpu_ftan(uint64_t a);
_MIASM_EXPORT uint64_t fpu_frndint(uint64_t a);
_MIASM_EXPORT uint64_t fpu_fsin(uint64_t a);
_MIASM_EXPORT uint64_t fpu_fcos(uint64_t a);
_MIASM_EXPORT uint64_t fpu_fscale(uint64_t a, uint64_t b);
_MIASM_EXPORT uint64_t fpu_f2xm1(uint64_t a);
...
_MIASM_EXPORT uint64_t fpu_fchs64(uint64_t a);
_MIASM_EXPORT uint64_t fpu_fyl2x(uint64_t a, uint64_t b);
_MIASM_EXPORT uint64_t fpu_fpatan(uint64_t a, uint64_t b);
_MIASM_EXPORT unsigned int fpu_fcom_c0(uint64_t a, uint64_t b);
_MIASM_EXPORT unsigned int fpu_fcom_c1(uint64_t a, uint64_t b);
_MIASM_EXPORT unsigned int fpu_fcom_c2(uint64_t a, uint64_t b);
_MIASM_EXPORT unsigned int fpu_fcom_c3(uint64_t a, uint64_t b);
